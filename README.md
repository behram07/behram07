...
Alongside my studies, I work on freelance projects — primarily developing **web** and **mobile applications**. I'm passionate about building user-centric solutions and making technology more accessible and intelligent.

My long-term goal is to specialize in **Artificial Intelligence**, with a strong focus on:
- Machine Learning (ML)
- Computer Vision (CV)
...
**Discount App (Kotlin + Firebase)**  
Mobile app that delivers customized coupons. Includes birthday-based notifications and real-time updates.
